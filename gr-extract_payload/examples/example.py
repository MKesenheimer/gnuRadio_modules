...
class example(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.extract_payload_1 = extract_payload.extract_payload((0, 0, 0), 32, 32)
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_throttle2_0, 0), (self.extract_payload_1, 0))
        self.connect((self.blocks_vector_source_x_0, 0), (self.blocks_throttle2_0, 0))
        self.connect((self.extract_payload_1, 0), (self.blocks_vector_sink_x_0, 0))
